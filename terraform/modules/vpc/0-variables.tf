...
variable "outposts_subnets_internet_access_nat_gw" {
  description = "[optional] connectivity with nat gw. Boolean. False by default."
  type        = bool
  default     = false
}
...
variable "endpoints_ha" {
  description = "[optional] Enable or disable the creation of endpoints in 2 AZ. If false, endpoints will be created in one subnet. If true, in 2 AZ."
  type        = bool
  default     = false
}
